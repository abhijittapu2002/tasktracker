...
export class AdminDashboardComponent implements OnInit {
  ...
  _EmpList: any[] = [];             // All users (for admin dropdown)
  ...
  ngOnInit(): void {
    ...
    this.loadUsers(); // ✅ Load users if admin
  ...
  navigateToKanbanView() {
    if (this.selectedEmployee) {
      this.router.navigate(['/admin/kanbanView'], { 
